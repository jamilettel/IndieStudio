...
void is::scenes::GameScene::initEntities()
{
    ...
    initEntity(prefabs::GlobalPrefabs::createPlayer(irr::core::vector3df(-5 * 3, 0, 6 * 3), is::ecs::AScene::_entitySaver));
    initEntity(prefabs::GlobalPrefabs::createAI(irr::core::vector3df(-5 * 3, 0, -6 * 3), is::ecs::AScene::_entitySaver));
    initEntity(prefabs::GlobalPrefabs::createAI(irr::core::vector3df(5 * 3, 0, -6 * 3), is::ecs::AScene::_entitySaver));
    initEntity(prefabs::GlobalPrefabs::createAI(irr::core::vector3df(5 * 3, 0, 6 * 3), is::ecs::AScene::_entitySaver));
}
