...
void is::systems::ModelRendererSystem::awake()
{
    for (auto &elem : _componentManager->getComponentsByType(typeid(is::components::ModelRendererComponent).hash_code())) {
        ...
        if (!ptr)
            throw new is::exceptions::Exception("ModelRendererSystem", "Could not get ModelRendererComponent pointer");
        ...
        for (auto &wc : _componentManager->getComponentsByType(typeid(is::components::WindowComponent).hash_code())) {
            ...
            if (!ptr_window)
                throw new is::exceptions::Exception("ModelRendererSystem", "Could not get WindowComponent pointer");
        ...
        if (!windowFound)
            throw new is::exceptions::Exception("ModelRendererSystem", "Could not found window");
...
void is::systems::ModelRendererSystem::update()
{
    for (auto &elem : _componentManager->getComponentsByType(typeid(is::components::ModelRendererComponent).hash_code())) {
        ...
        if (!tr)
            throw new is::exceptions::Exception("ModelRendererSystem", "Could not get TransformComponent pointer");
